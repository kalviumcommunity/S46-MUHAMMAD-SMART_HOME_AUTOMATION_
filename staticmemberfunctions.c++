...
public:
    ...
    // Static method to reset the onCount (turn off all appliances)
    static void resetOnCount() {
        onCount = 0;
        cout << "All appliances have been reset to OFF. Total ON appliances: " << onCount << endl;
    }
};
...
public:
    ...
    // Static method to reset the entire control system (all appliances to off)
    static void resetSystem() {
        Appliance::resetOnCount();
    }
};
...
int main() {
    ...
    // Reset the system (turn off all appliances)
    ControlSystem::resetSystem();
